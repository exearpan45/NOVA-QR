...
export const CustomQRDesigner: React.FC<CustomQRDesignerProps> = ({
  ...
  const scrollToPreview = () => {
    const el = document.getElementById('designer-preview-section');
    if (el) {
    ...
    <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 py-6 space-y-6 animate-fadeIn">
      ...
      <div className={`flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b ${
        ...
        <div>
          <div className="flex items-center gap-2.5">
            <div className={`p-2.5 rounded-xl border shadow-xs ${
              isDark
                ? 'bg-gradient-to-tr from-cyan-500/20 to-blue-500/10 text-cyan-400 border-cyan-500/30'
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button
            ...
            className={`lg:hidden flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-bold border transition cursor-pointer active:scale-95 ${
              isDark
                ? 'bg-cyan-500/15 hover:bg-cyan-500/25 text-cyan-300 border-cyan-400/40'
          ...
          >
            <Printer className={`w-3.5 h-3.5 ${isDark ? 'text-slate-400' : 'text-slate-600'}`} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          <div className={`flex items-center gap-1 p-1 rounded-2xl border overflow-x-auto scrollbar-none shadow-xs ${
          ...
          {/* TAB 1: FRAMES & BADGES */}
          {activeStudioTab === 'frames' && (
            <div className={`p-4 sm:p-5 rounded-3xl border shadow-xs space-y-5 ${
                    ...
                    >
                      <div className="flex items-center justify-between mb-1">
                        <span className={`text-xs font-bold ${
                          designerConfig.frameType === frm.id && !isDark
                            ? 'text-cyan-950'
                            : isDark
                            ? 'text-slate-200'
                            : 'text-slate-800'
                      ...
                      <p className={`text-[10px] ${isDark ? 'text-slate-400' : 'text-slate-600'}`}>{frm.desc}</p>
                    </button>
                  ))}
                </div>
              </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-3.5 py-2 rounded-xl text-xs sm:text-sm border outline-none uppercase font-bold ${
                          isDark
                            ? 'bg-slate-950/80 border-slate-800 text-slate-100 focus:border-cyan-400'
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <div>
                      ...
                      <div className={`flex items-center gap-2 p-1.5 rounded-xl border ${
                        ...
                        />
                        <span className={`text-xs font-mono ${isDark ? 'text-slate-300' : 'text-slate-800 font-medium'}`}>{designerConfig.frameBgColor}</span>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className={`flex items-center gap-2 p-1.5 rounded-xl border ${
                        ...
                        <input
                          ...
                          className="w-7 h-7 rounded-lg cursor-pointer bg-transparent border-0"
                        />
                        <span className={`text-xs font-mono ${isDark ? 'text-slate-300' : 'text-slate-800 font-medium'}`}>{designerConfig.frameTextColor}</span>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className={`flex items-center gap-2 p-1.5 rounded-xl border ${
                        ...
                        <input
                          ...
                          className="w-7 h-7 rounded-lg cursor-pointer bg-transparent border-0"
                        />
                        <span className={`text-xs font-mono ${isDark ? 'text-slate-300' : 'text-slate-800 font-medium'}`}>{designerConfig.frameAccentColor}</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className={`p-4 sm:p-5 rounded-3xl border shadow-xs space-y-4 ${
              ...
              <div>
                <h3 className={`text-sm font-bold mb-1 ${isDark ? 'text-white' : 'text-slate-900'}`}>
                  1-Click Curated Designer Templates
                </h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {DESIGNER_TEMPLATES.map((tpl) => (
                  <button
                    ...
                    className={`p-4 rounded-2xl border transition cursor-pointer text-left group relative overflow-hidden shadow-xs ${
                      isDark
                        ? 'border-slate-800 bg-slate-950/60 hover:border-cyan-500/50'
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className={`text-[10px] px-2 py-0.5 rounded-full font-mono border ${
                        isDark ? 'bg-white/10 text-slate-300 border-transparent' : 'bg-slate-200 text-slate-800 border-slate-300'
                      }`}>
                        {tpl.designerConfig.frameType}
                      </span>
                    </div>
                    <p className={`text-xs mb-3 ${isDark ? 'text-slate-300' : 'text-slate-600'}`}>{tpl.tagline}</p>
                      ...
                      className={`py-2 px-2.5 rounded-xl text-xs font-semibold border text-center transition cursor-pointer capitalize ${
                        styleConfig.dotType === type
                          ? isDark
                            ...
                            : 'border-cyan-600 bg-cyan-50 text-cyan-900 font-bold ring-1 ring-cyan-600/40'
                          : isDark
                ...
                <div className="flex items-center justify-between mb-3">
                  <div>
                    ...
                    <p className={`text-[11px] ${isDark ? 'text-slate-400' : 'text-slate-600'}`}>
                      Add dynamic color blending to the QR matrix
                    </p>
                  </div>
                  <button
                    type="button"
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition cursor-pointer ${
                      styleConfig.gradient?.enabled ? 'bg-cyan-500' : isDark ? 'bg-slate-800' : 'bg-slate-300'
                    }`}
                  >
                    <span
                      ...
                      <div>
                        ...
                        <div className={`flex items-center gap-2 p-1.5 rounded-xl border ${
                          ...
                          <input
                            ...
                            className="w-7 h-7 rounded-lg cursor-pointer bg-transparent border-0"
                          />
                          <span className={`text-xs font-mono ${isDark ? 'text-slate-200' : 'text-slate-800 font-medium'}`}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div className={`p-3 rounded-2xl border space-y-2 ${
                    ...
                    <div className="flex items-center gap-2 pt-1">
                      ...
                      />
                      <span className={`text-xs font-mono ${isDark ? 'text-slate-300' : 'text-slate-800 font-medium'}`}>
            ...
            <div className={`p-4 sm:p-5 rounded-3xl border shadow-xs space-y-5 ${
              ...
              <div className={`pt-3 border-t space-y-3 ${isDark ? 'border-slate-800' : 'border-slate-200'}`}>
                ...
                <div className="flex items-center gap-3">
                  <label className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold transition cursor-pointer border ${
                    isDark
                      ? 'bg-slate-800 hover:bg-slate-700 text-slate-200 border-slate-700'
                      : 'bg-white hover:bg-slate-100 text-slate-800 border-slate-300 shadow-xs'
                  }`}>
                  ...
                  {styleConfig.logoUrl && (
                    <button
                      ...
                      className="text-xs text-rose-500 hover:text-rose-600 font-medium transition cursor-pointer"
                    >
                      Remove Logo
                    </button>
                  )}
                ...
                {styleConfig.logoUrl && (
                  <div className="pt-2">
                    <div className={`flex items-center justify-between text-xs mb-1 ${
                      ...
                      <span className={`font-mono font-bold ${isDark ? 'text-cyan-400' : 'text-cyan-700'}`}>
                        {Math.round(styleConfig.logoSize * 100)}%
                      </span>
                    </div>
                    <input
                      type="range"
            ...
            <div className={`p-4 sm:p-5 rounded-3xl border shadow-xs space-y-4 ${
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-xl text-xs sm:text-sm border outline-none font-mono ${
                    isDark
                      ? 'bg-slate-950/80 border-slate-800 text-slate-100 focus:border-cyan-400'
                      : 'bg-slate-50 border-slate-300 text-slate-900 focus:border-cyan-600'
                  }`}
        ...
        <div id="designer-preview-section" className="lg:col-span-5 flex flex-col items-center scroll-mt-24">
          <div className="w-full sticky top-24 space-y-4">
            {/* The Live Composite Card Preview */}
            <div className={`flex justify-center p-4 rounded-3xl border shadow-xl ${
              isDark ? 'bg-slate-950/60 border-slate-800/80' : 'bg-slate-100/90 border-slate-200'
            }`}>
              <div
            ...
            <div className={`p-3 rounded-2xl border flex items-center justify-between gap-2 shadow-xs ${
              isDark ? 'bg-slate-900/60 border-slate-800' : 'bg-white border-slate-200'
            }`}>
              <span className={`text-xs font-semibold pl-1 ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>
                Export Graphic
              </span>
              <div className="flex items-center gap-1.5">
                <button
                  type="button"
                  onClick={() => handleCompositeDownload('png')}
                  className="px-3 py-1.5 rounded-xl text-xs font-bold bg-cyan-500 hover:bg-cyan-400 text-slate-950 transition cursor-pointer shadow-xs"
                >
                  PNG
                </button>
                <button
